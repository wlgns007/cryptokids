...
const MESSAGES = {
  en: {
    ...
    'tabs.memberMgmt': 'Member Management',
    'tabs.registerMember': 'Register New Member',
    'tabs.existingMembers': 'Existing Members',
  ...
  ko: {
    'app.title': '크립토키즈 관리자',
    'tabs.memberMgmt': '회원 관리',
    'tabs.registerMember': '신규 회원 등록',
    'tabs.existingMembers': '기존 회원',
